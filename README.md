...
Chaque graphique regroupe l'évolution d'un polluant pour une base de données choisis. On a utilisé le module express de plotly pour générer les points, et le module graph_objects afin d'ajouter les traces qui relient les points, pour obtenir les graphiques.
