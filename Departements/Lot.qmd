...
for polluant in polluants:
    # Filtrer les données pour le polluant et le département LOT
    filtered_data = bdd1[(bdd1['nom_dept'] == 'LOT') & (bdd1['nom_poll'] == polluant)]
    ...
    fig = px.scatter(
        ...
        title=f'Évolution de la pollution {polluant} dans le LOT',
    ...
    fig.update_layout(
        title_text=f'Évolution de la pollution {polluant} dans le LOT',
...
# Boucle à travers les polluants pour créer les graphiques
for polluant in polluants:
    # Filtrer les données pour le polluant et le département du LOT
    filtered_data = bdd1[(bdd1['nom_dept'] == 'LOT') & (bdd1['nom_poll'] == polluant)]
    filtered_data = filtered_data.sort_values(by='date_debut')
