...
ordonnee_ranges = {'NO': [0, 15], 'NOX': [0, 25], 'O3': [0, 90], 'PM10': [0, 30], 'NO2': [0, 20]}

# Boucle à travers les polluants pour créer les graphiques
for polluant in polluants:
    # Filtrer les données pour le polluant et le département ARIEGE
    ...
    fig = px.scatter(
        ...
        title=f'Évolution de la pollution {polluant} en ARIEGE',
