...
ordonnee_ranges = {'NO': [0, 20], 'NOX': [0, 45], 'O3': [0, 90], 'PM10': [0, 25], 'NO2': [0, 25]}

# Boucle à travers les polluants pour créer les graphiques
for polluant in polluants:
    # Filtrer les données pour le polluant et le département AVEYRON
    filtered_data = bdd1[(bdd1['nom_dept'] == 'AVEYRON') & (bdd1['nom_poll'] == polluant)]
    ...
    fig = px.scatter(
        ...
        title=f'Évolution de la pollution {polluant} en AVEYRON',
    ...
    fig.update_layout(
        title_text=f'Évolution de la pollution {polluant} en AVEYRON',
...
# Plages des ordonnées pour chaque polluant
ordonnee_ranges = {'NO': [0, 15], 'NOX': [0, 40], 'O3': [0, 90], 'PM10': [0, 20], 'NO2': [0, 20]}
