...
ordonnee_ranges = {'NO': [0, 25], 'NOX': [0, 45], 'O3': [0, 90], 'PM10': [0, 30], 'NO2': [0,20]}

# Boucle à travers les polluants pour créer les graphiques
for polluant in polluants:
    # Filtrer les données pour le polluant et le département GERS
    filtered_data = bdd1[(bdd1['nom_dept'] == 'GERS') & (bdd1['nom_poll'] == polluant)]
    ...
    fig = px.scatter(
        ...
        title=f'Évolution de la pollution {polluant} dans le GERS',
    ...
    fig.update_layout(
        title_text=f'Évolution de la pollution {polluant} dans le GERS',
...
# Plages des ordonnées pour chaque polluant
ordonnee_ranges = {'O3': [0, 90], 'PM10': [0, 20]}
