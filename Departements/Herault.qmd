...
ordonnee_ranges = {'NO': [0, 100], 'NOX': [0, 220], 'O3': [10, 90], 'PM10': [0, 35], 'NO2': [0, 70]}

# Boucle à travers les polluants pour créer les graphiques
for polluant in polluants:
    # Filtrer les données pour le polluant et le département HERAULT
    filtered_data = bdd1[(bdd1['nom_dept'] == 'HERAULT') & (bdd1['nom_poll'] == polluant)]
    ...
    fig = px.scatter(
        ...
        title=f'Évolution de la pollution {polluant} en HERAULT',
    ...
    fig.update_layout(
        title_text=f'Évolution de la pollution {polluant} en HERAULT',
...
# Plages des ordonnées pour chaque polluant
ordonnee_ranges = {'NO': [0, 55], 'NOX': [0, 125], 'O3': [40, 90], 'PM10': [5, 25], 'NO2': [0, 60]}
