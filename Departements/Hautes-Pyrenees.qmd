...
ordonnee_ranges = {'NO': [0, 25], 'NOX': [0, 60], 'O3': [0, 90], 'PM10': [0, 35], 'NO2': [0, 30]}

# Boucle à travers les polluants pour créer les graphiques
for polluant in polluants:
    # Filtrer les données pour le polluant et le département HAUTES-PYRENEES
    filtered_data = bdd1[(bdd1['nom_dept'] == 'HAUTES-PYRENEES') & (bdd1['nom_poll'] == polluant)]
    ...
    fig = px.scatter(
        ...
        title=f'Évolution de la pollution {polluant} en HAUTES-PYRENEES',
    ...
    fig.update_layout(
        title_text=f'Évolution de la pollution {polluant} en HAUTES-PYRENEES',
...
# Plages des ordonnées pour chaque polluant
ordonnee_ranges = {'NO': [0, 15], 'NOX': [0, 25], 'O3': [40, 70], 'PM10': [5, 25], 'NO2': [0, 20]}
