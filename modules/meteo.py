...
def graphique_polar(fig):
    ...
    fig.update_layout(
        ...
        polar=dict(
            ...
            radialaxis=dict(showline=True, linewidth=2, gridcolor="rgba(100, 100, 100,0.5)", gridwidth=2),
...
def graphique_axe(fig, titre, yaxis2_title):
    ...
    fig.update_layout(
        ...
        yaxis2=dict(title=yaxis2_title, overlaying='y',side='right', position=1), # Deuxième ordonnée
        font_size=15,
        showlegend=True,
        paper_bgcolor="rgba(230, 230, 230,0)", # Couleur de contour de graphique 
