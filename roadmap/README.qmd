...
Vous trouverez aussi une page "Villes". Nous souhaitons voir l'état de la pollution en milieu ultra-urbain dans les 3 plus grandes villes de la région pour se rendre compte de la différence avec un milieu plus rural, tout cela à travers un graphique interactif comparant les taux de pollution, selon les polluants, dans ces 3 grandes villes, comparés à la moyenne régionale. Pour cela nous allons principalement utiliser le package "seaborn" pour la modélisation des données et l'interactivité des graphiques.
