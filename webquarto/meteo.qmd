...
mois_mapping = {"01": "Janvier", "02": "Février", "03": "Mars", "04": "Avril", "05": "Mai", "06": "Juin",
                "07": "Juillet", "08": "Août", "09": "Septembre", "10": "Octobre", "11": "Novembre", "12": "Décembre"}
jours_mapping = {"Monday": "Lundi", "Tuesday": "Mardi", "Wednesday": "Mercredi",
...
def concentration(date, format, mapping, titre, temps):
    ...
    fig.add_trace(md.trace(PM, 'blue', 'PM10', date))
...
# Graphique mois
concentration('Mois', '%m', mois_mapping,
...
```{python}
# Graphique jour
concentration('Jour', '%A', jours_mapping,
