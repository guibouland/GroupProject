...
md.graphique(figmtp, {"text": "<b>Différences à Montpellier</b>",'x':0.5,'xanchor': 'center'}, "<b>Mois</b>")
figmtp.update_layout(font=dict(color='Grey', size=10)) # Couleur et taille de l'écriture
figmtp.update_layout(yaxis=dict(title="<b>Concentration (µg.m⁻³)</b>", side="left", position=0)) # On met en gras l'axe des ordonnées
...
<p style="text-align: center;"><b>Double-cliquez sur les stations dans la légende pour isoler un polluant.</b><br>(faire de même pour changer de polluant)</p>
\
...
# On modifie le layout du graphique
md.graphique(figtou, {"text": "<b>Différences à Toulouse</b>",'x':0.5,'xanchor': 'center'}, "<b>Mois</b>")
figtou.update_layout(font=dict(color='Grey', size=10)) # Couleur et taille de l'écriture
figtou.update_layout(yaxis=dict(title="<b>Concentration (µg.m⁻³)</b>", side="left", position=0)) # On met en gras l'axe des ordonnées
...
- **Toulouse** :
  - "*[Toulouse-Berthelot Urbain](https://www.google.com/maps/place/43%C2%B035'14.3%22N+1%C2%B026'38.5%22E/@43.5873,1.4414551,17z/data=!3m1!4b1!4m4!3m3!8m2!3d43.5873!4d1.44403?entry=ttu)*" : pour les mêmes raisons que pour "*Montpellier - Prés d Arènes Urbain*"
...
# On modifie le layout du graphique
md.graphique(fig, {"text": "<b>Comparaison entre différentes villes d'Occitanie</b>",'x':0.5,'xanchor': 'center'}, "<b>Mois</b>")
fig.update_layout(font=dict(color='Grey', size=10)) # Couleur et taille de l'écriture
fig.update_layout(yaxis=dict(title="<b>Concentration (µg.m⁻³)</b>", side="left", position=0)) # On met en gras l'axe des ordonnées
