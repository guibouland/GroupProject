...
polluant=pd.read_csv('bases_de_donnees/Mesure_mensuelle_annee.csv',sep=",", na_values="", low_memory=False)
polluants=polluant.dropna()
polluants['Date_'] = pd.to_datetime(polluants['date_debut'])
polluants['Date'] = polluants['Date_'].dt.strftime('%Y %m')
polluants=polluants.groupby(['X','Y','nom_poll'])['valeur'].mean().reset_index(name='valeur')
print(polluants)
#PM10
...
pm10=HeatMap(list(zip(lat, lng, val)),name='PM10',gradient={0: '#0d0887', 0.1: '#41049d',0.2: "#6a00a8",0.3:"#8f0da4",0.4:"#b12a90", 0.5:"#cc4778",0.6:"#e16462", 0.7:"#f2844b",0.8:"#fca636",0.9:"#fcce25", 1: '#f0f921'},radius=40, blur=35)
...
pm2=HeatMap(list(zip(lat, lng, val)),name='PM2.5',gradient={0: '#0d0887', 0.1: '#41049d',0.2: "#6a00a8",0.3:"#8f0da4",0.4:"#b12a90", 0.5:"#cc4778",0.6:"#e16462", 0.7:"#f2844b",0.8:"#fca636",0.9:"#fcce25", 1: '#f0f921'},radius=40, blur=35)
...
no=HeatMap(list(zip(lat, lng, val)),name='NO',gradient={0: '#0d0887', 0.1: '#41049d',0.2: "#6a00a8",0.3:"#8f0da4",0.4:"#b12a90", 0.5:"#cc4778",0.6:"#e16462", 0.7:"#f2844b",0.8:"#fca636",0.9:"#fcce25", 1: '#f0f921'},radius=40, blur=35)
...
no2=HeatMap(list(zip(lat, lng, val)),name='NO2',gradient={0: '#0d0887', 0.1: '#41049d',0.2: "#6a00a8",0.3:"#8f0da4",0.4:"#b12a90", 0.5:"#cc4778",0.6:"#e16462", 0.7:"#f2844b",0.8:"#fca636",0.9:"#fcce25", 1: '#f0f921'},radius=40, blur=35)
...
o3=HeatMap(list(zip(lat, lng, val)),name='O3',gradient={0: '#0d0887', 0.1: '#41049d',0.2: "#6a00a8",0.3:"#8f0da4",0.4:"#b12a90", 0.5:"#cc4778",0.6:"#e16462", 0.7:"#f2844b",0.8:"#fca636",0.9:"#fcce25", 1: '#f0f921'},radius=40, blur=35)
