...
PM2022=PM[(PM['Date'] == '2023')]

heatPM10 = PM2022[["Y", "X", "valeur"]].copy()
heatPM=heatPM10.dropna()

lng = heatPM['X'].tolist()
lat = heatPM['Y'].tolist()
val = heatPM['valeur'].tolist()
pm10=HeatMap(list(zip(lat, lng, val)),name='PM10',gradient={0: '#97ECF0', 0.3: '#73B5FA', 0.5:"#9A73FA", 0.7:"#FF37C8", 1: 'red'})
pm10.add_to(Occitanie)


#NOX
NOX = polluants[(polluants['nom_poll'] == 'NOX')]
NOX2022=NOX[(NOX['Date'] == '2023')]
...
nox=HeatMap(list(zip(lat, lng, val)),name='NOX',gradient={0: '#97ECF0', 0.3: '#73B5FA', 0.5:"#9A73FA", 0.7:"#FF37C8", 1: 'red'})
nox.add_to(Occitanie)
folium.TileLayer('CartoDB Positron').add_to(Occitanie)
