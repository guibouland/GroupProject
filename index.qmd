...
<table class= "table1-style">
    <tr>  
        <th  style="border-top-left-radius : 10px 10px;border-bottom-left-radius : 10px 10px;"> faible </th>
        <th  style="border-top-right-radius : 10px 10px;border-bottom-right-radius : 10px 10px;"> forte </th>
    </tr>
</table>
"""
HTML(res)
